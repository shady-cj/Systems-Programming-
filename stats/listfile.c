...
int main(int argc, char *argv[])
{
	...
	/* Array of file types indexed by the
	 * top four bits of st_mode */

	char *filetype[] = {"unknown", "FIFO", "character device",
		"unknown", "directory", "unknown", "block device",
		"unknown", "file", "unknown", "symlink", "unknown", "socket" };
